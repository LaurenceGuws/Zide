...
const app_search_panel_state = @import("app/search/search_panel_state.zig");
const app_shell = @import("app_shell.zig");
const app_state_mod = @import("app/app_state.zig");
const app_tab_action_apply_runtime = @import("app/tabs/tab_action_apply_runtime.zig");
const app_terminal_close_confirm_decision_runtime = @import("app/terminal/terminal_close_confirm_decision_runtime.zig");
const app_terminal_runtime_intents = @import("app/terminal/terminal_runtime_intents.zig");
