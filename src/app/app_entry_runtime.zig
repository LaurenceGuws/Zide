...
const macos_metal_terminal_diagnostic_runtime = @import("macos_metal_terminal_diagnostic_runtime.zig");
const macos_metal_text_diagnostic_runtime = @import("macos_metal_text_diagnostic_runtime.zig");
...
pub fn runFromArgs(allocator: std.mem.Allocator) !void {
    ...
    switch (startup_command) {
        ...
        .macos_metal_text_diagnostic => return try macos_metal_text_diagnostic_runtime.run(allocator),
        .macos_metal_terminal_diagnostic => return try macos_metal_terminal_diagnostic_runtime.run(allocator),
