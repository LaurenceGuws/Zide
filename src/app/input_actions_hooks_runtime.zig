...
const app_terminal_shortcut_policy = @import("terminal_shortcut_policy.zig");
const app_terminal_shortcut_runtime = @import("terminal_shortcut_runtime.zig");
...
const app_terminal_intent_route_runtime = @import("terminal_intent_route_runtime.zig");
const app_tab_action_apply_runtime = @import("tab_action_apply_runtime.zig");
const app_terminal_close_active_runtime = @import("terminal_close_active_runtime.zig");
