...
fn initWithMode(
    ...
    state.* = .{
        ...
        .needs_redraw = true,
        .idle_frames = 0,
        .last_terminal_draw_seq = 0,
        .last_terminal_poll_seq = 0,
        .terminal_pressure_since = null,
        .last_terminal_observed_generation = 0,
        .last_terminal_observed_current_generation = 0,
        .last_terminal_drawn_generation = 0,
        .last_terminal_generation_change_time = 0,
