...
const terminal_shortcuts = @import("terminal_shortcuts.zig");
...
pub const TerminalShortcutCycleDirection = terminal_shortcuts.CycleDirection;
pub const TerminalShortcutIntent = terminal_shortcuts.ShortcutIntent;
pub const terminalShortcutIntentForAction = terminal_shortcuts.terminalShortcutIntentForAction;
...
pub const TabDragReleasePlan = tab_drag.ReleasePlan;
pub const TabDragFrame = tab_drag.DragFrame;
pub const processTabDragFrame = tab_drag.processDragFrame;
pub const terminalTabDragReleasePlan = tab_drag.terminalReleasePlan;
pub const ideEditorTabDragReleasePlan = tab_drag.ideEditorReleasePlan;
