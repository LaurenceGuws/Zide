...
pub const KEY_F1 = @as(i32, @intCast(sdl.SDL_SCANCODE_F1));
pub const KEY_F2 = @as(i32, @intCast(sdl.SDL_SCANCODE_F2));
pub const KEY_F3 = @as(i32, @intCast(sdl.SDL_SCANCODE_F3));
pub const KEY_F4 = @as(i32, @intCast(sdl.SDL_SCANCODE_F4));
pub const KEY_F5 = @as(i32, @intCast(sdl.SDL_SCANCODE_F5));
pub const KEY_F6 = @as(i32, @intCast(sdl.SDL_SCANCODE_F6));
pub const KEY_F7 = @as(i32, @intCast(sdl.SDL_SCANCODE_F7));
pub const KEY_F8 = @as(i32, @intCast(sdl.SDL_SCANCODE_F8));
pub const KEY_F9 = @as(i32, @intCast(sdl.SDL_SCANCODE_F9));
pub const KEY_F10 = @as(i32, @intCast(sdl.SDL_SCANCODE_F10));
pub const KEY_F11 = @as(i32, @intCast(sdl.SDL_SCANCODE_F11));
pub const KEY_F12 = @as(i32, @intCast(sdl.SDL_SCANCODE_F12));
