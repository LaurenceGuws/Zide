...
pub const GenerationState = publication_capture.GenerationState;
...
pub fn generationState(self: anytype) GenerationState {
    return publication_capture.generationState(self);
}
...
pub fn publishedGeneration(self: anytype) u64 {
    return publication_capture.publishedGeneration(self);
}
...
pub fn presentedGeneration(self: anytype) u64 {
    return publication_capture.presentedGeneration(self);
}
