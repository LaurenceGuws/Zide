...
public final class TerminalActivityViewBindings {
    ...
    public static TerminalActivityViewBindings from(Activity activity) {
        return new TerminalActivityViewBindings(
                ...
                activity.findViewById(R.id.product_bootstrap_title),
                activity.findViewById(R.id.product_bootstrap_detail),
                activity.findViewById(R.id.product_bootstrap_retry_button),
                activity.findViewById(R.id.product_bootstrap_debug_button),
                activity.findViewById(R.id.root_view),
                activity.findViewById(R.id.product_view),
                activity.findViewById(R.id.debug_view),
                activity.findViewById(R.id.product_bootstrap_blocker),
