...
Use it for:
- source-review findings and rationale
- implementation increment logs with file/test evidence
- dated change history

Use `app_architecture/terminal/protocol/ACCURACY_PROGRESS.md` for the active
tracker, partial-discipline policy, and current next-work queue.
