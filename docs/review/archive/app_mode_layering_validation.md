...
- `tools/build_tools/gates/mode_gates.sh fast`
- `tools/build_tools/gates/mode_gates.sh full`
- `tools/build_tools/gates/mode_gates.sh manual-smokes`

Binary size tracking:

- `zig build mode-size-report`
- `zig build mode-size-check`
- or `tools/build_tools/reports/report_mode_binary_sizes.sh` after `zig build`
