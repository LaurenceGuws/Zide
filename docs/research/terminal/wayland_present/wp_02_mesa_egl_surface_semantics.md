...
- [egl.rst](../../../../reference_repos/rendering/mesa/docs/egl.rst)
- [eglsurface.c](../../../../reference_repos/rendering/mesa/src/egl/main/eglsurface.c)
- [eglcontext.c](../../../../reference_repos/rendering/mesa/src/egl/main/eglcontext.c)
- [eglSwapBuffers.md](../../../../reference_repos/rendering/khronos_refpages_md/EGL/eglSwapBuffers.md)
- [eglQuerySurface.md](../../../../reference_repos/rendering/khronos_refpages_md/EGL/eglQuerySurface.md)
- [eglGetConfigAttrib.md](../../../../reference_repos/rendering/khronos_refpages_md/EGL/eglGetConfigAttrib.md)
- [eglQueryContext.md](../../../../reference_repos/rendering/khronos_refpages_md/EGL/eglQueryContext.md)
...
2. Generic Mesa surface initialization treats window-surface swap as
   ...
   In [_eglInitSurface()](../../../../reference_repos/rendering/mesa/src/egl/main/eglsurface.c),
...
3. For window surfaces, `eglQuerySurface(EGL_RENDER_BUFFER)` returns the
   ...
   Mesa's
   [_eglQuerySurface()](../../../../reference_repos/rendering/mesa/src/egl/main/eglsurface.c)
...
4. `eglQueryContext(EGL_RENDER_BUFFER)` is the actual context-side authority.
   Mesa's
   [_eglQueryContext()](../../../../reference_repos/rendering/mesa/src/egl/main/eglcontext.c)
...
5. Mutable render-buffer behavior is optional and tightly gated.
   In [_eglSurfaceAttrib()](../../../../reference_repos/rendering/mesa/src/egl/main/eglsurface.c),
