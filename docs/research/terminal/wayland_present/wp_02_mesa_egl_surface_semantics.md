...
- [egl.rst](../../../../dev_references/rendering/mesa/docs/egl.rst)
- [eglsurface.c](../../../../dev_references/rendering/mesa/src/egl/main/eglsurface.c)
- [eglcontext.c](../../../../dev_references/rendering/mesa/src/egl/main/eglcontext.c)
- [eglSwapBuffers.md](../../../../dev_references/rendering/khronos_refpages_md/EGL/eglSwapBuffers.md)
- [eglQuerySurface.md](../../../../dev_references/rendering/khronos_refpages_md/EGL/eglQuerySurface.md)
- [eglGetConfigAttrib.md](../../../../dev_references/rendering/khronos_refpages_md/EGL/eglGetConfigAttrib.md)
- [eglQueryContext.md](../../../../dev_references/rendering/khronos_refpages_md/EGL/eglQueryContext.md)
...
2. Generic Mesa surface initialization treats window-surface swap as
   ...
   In [_eglInitSurface()](../../../../dev_references/rendering/mesa/src/egl/main/eglsurface.c),
...
3. For window surfaces, `eglQuerySurface(EGL_RENDER_BUFFER)` returns the
   ...
   Mesa's
   [_eglQuerySurface()](../../../../dev_references/rendering/mesa/src/egl/main/eglsurface.c)
...
4. `eglQueryContext(EGL_RENDER_BUFFER)` is the actual context-side authority.
   Mesa's
   [_eglQueryContext()](../../../../dev_references/rendering/mesa/src/egl/main/eglcontext.c)
...
5. Mutable render-buffer behavior is optional and tightly gated.
   In [_eglSurfaceAttrib()](../../../../dev_references/rendering/mesa/src/egl/main/eglsurface.c),
