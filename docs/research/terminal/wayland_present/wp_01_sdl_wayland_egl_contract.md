...
1. SDL's generic `SDL_GL_SwapWindow()` contract is too coarse to be the real
   ...
   [SDL_GL_SwapWindow.md](../../../../dev_references/sdlwiki_md/SDL3/SDL_GL_SwapWindow.md)
   and
   [SDL_waylandopengles.c](../../../../dev_references/backends/sdl/src/video/wayland/SDL_waylandopengles.c).
...
5. SDL uses Wayland frame callbacks as part of its presentation contract and
   ...
   [SDL_waylandwindow.c](../../../../dev_references/backends/sdl/src/video/wayland/SDL_waylandwindow.c).
...
6. Window-surface ownership is dynamic on Wayland and not all native objects
   ...
   See
   [SDL_GetWindowProperties.md](../../../../dev_references/sdlwiki_md/SDL3/SDL_GetWindowProperties.md).
...
7. SDL exposes enough EGL state directly for runtime contract inspection.
   ...
   See:
   [SDL_EGL_GetCurrentDisplay.md](../../../../dev_references/sdlwiki_md/SDL3/SDL_EGL_GetCurrentDisplay.md),
   [SDL_EGL_GetCurrentConfig.md](../../../../dev_references/sdlwiki_md/SDL3/SDL_EGL_GetCurrentConfig.md),
   and
   [SDL_EGL_GetWindowSurface.md](../../../../dev_references/sdlwiki_md/SDL3/SDL_EGL_GetWindowSurface.md).
...
8. SDL owns EGL window-surface creation/destruction, and Wayland window resize
   ...
   See
   [SDL_egl.c](../../../../dev_references/backends/sdl/src/video/SDL_egl.c),
   [SDL_waylandwindow.c](../../../../dev_references/backends/sdl/src/video/wayland/SDL_waylandwindow.c).
