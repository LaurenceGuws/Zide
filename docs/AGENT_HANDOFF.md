...
- Clipboard/paste ownership also moved forward: system clipboard paste fallback policy (scrollback reset, OSC 5522 attempt, bracketed paste framing, ESC/Ctrl-C filtering) now lives in backend code instead of `terminal_widget.zig`.
