...
- Active macro batch (`in_progress`, super-gate `CZH-GATE-99`): `CZH-B45` in
...
- Active ticket source: `docs/todo/core/CZH_S40_TICKETS.md`
...
Current batch status (`CZH-B45`, in progress toward `CZH-GATE-99`):

- target: consolidate refresh/reuse transport boundaries while preserving terminal-owned decision/fold seams
...
4. `docs/todo/core/CZH_S40_TICKETS.md`
...
- Engineer executes the current sprint tickets in `docs/todo/core/JIRA_BOARD.md`
  and `docs/todo/core/CZH_S40_TICKETS.md` in listed order.
