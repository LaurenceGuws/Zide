...
- Active macro batch: `APX-B6` — **awaiting architect review** at super-gate (declared-slot value across interaction/widget/composition startup APIs; engineer validation complete).
