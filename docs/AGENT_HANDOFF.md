...
- Active macro batch (`in_progress`, super-gate `CZH-GATE-105`): `CZH-B51` in
...
- Active ticket source: `docs/todo/core/CZH_S46_TICKETS.md`
...
Current batch status (`CZH-B51`, in progress toward `CZH-GATE-105`):

- target: contract fold/result structs and collapse boundary callsites so routing remains canonical and single-path
...
4. `docs/todo/core/CZH_S46_TICKETS.md`
...
- Engineer executes the current sprint tickets in `docs/todo/core/JIRA_BOARD.md`
  and `docs/todo/core/CZH_S46_TICKETS.md` in listed order.
