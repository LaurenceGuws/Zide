...
- Active macro batch (`in_progress`, super-gate `CZH-GATE-110`): `CZH-B56` in
...
- Active ticket source: `docs/todo/core/CZH_S51_TICKETS.md`
...
Current batch status (`CZH-B56`, in progress toward `CZH-GATE-110`):

- target: prune remaining fold transport route duplication and minimize assertion surface to one canonical path per flow
...
4. `docs/todo/core/CZH_S51_TICKETS.md`
