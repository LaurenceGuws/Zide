...
- Active macro batch: `AHW-B10` — app-shell state contract cleanup with slot/chrome freezes preserved.
...
- Execute only the macro batch marked `in_progress`: `AHW-B10`.
- Stop at the `AHW-B10` super-gate and report the review packet.
