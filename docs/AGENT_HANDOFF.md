...
- Active macro batch (`in_progress`, super-gate `CZH-GATE-123`): `CZH-B69` in
...
- Active ticket source: `docs/todo/core/CZH_S64_TICKETS.md`
...
Current batch status (`CZH-B69`, in progress toward `CZH-GATE-123`):

- target: compact enforcement representation while preserving all established locks
- preserve sealed canonical surface and no-bypass guarantees
- preserve behavior and host ABI while reducing enforcement surface duplication
