...
- Active macro batch (`in_progress`, super-gate `CZH-GATE-102`): `CZH-B48` in
...
- Active ticket source: `docs/todo/core/CZH_S43_TICKETS.md`
...
Current batch status (`CZH-B48`, in progress toward `CZH-GATE-102`):

- target: collapse remaining boundary result transport duplication and narrow helper surfaces to one canonical route per flow
...
4. `docs/todo/core/CZH_S43_TICKETS.md`
...
- Engineer executes the current sprint tickets in `docs/todo/core/JIRA_BOARD.md`
  and `docs/todo/core/CZH_S43_TICKETS.md` in listed order.
