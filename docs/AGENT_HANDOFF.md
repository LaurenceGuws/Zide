...
- Active macro batch (`in_progress`): `AHW-B20` — keep-screen-on window-flag seam hardening, behavior-preserving.
...
- Execute only the macro batch marked `in_progress` in
  `docs/todo/android/implementation.md` (`AHW-B20`).
- Stop at the `AHW-B20` super-gate and return the review packet for Architect verdict.
