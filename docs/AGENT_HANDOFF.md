...
Current batch intent (`CZH-B7`):

- execute the first bounded implementation sprint from the accepted split
  authority
- remove one real product-path debug hook
- align FFI/export doc strings to the frozen ownership model
- keep behavior frozen and the stress ladder green
...
4. `docs/todo/core/CZH_S2_TICKETS.md`
...
- Engineer executes the current sprint tickets in `docs/todo/core/JIRA_BOARD.md`
  and `docs/todo/core/CZH_S2_TICKETS.md` in listed order.
