...
- Active macro batch (`in_progress`, super-gate `CZH-GATE-88`): `CZH-B34` in
...
Current batch intent (`CZH-B34`, in progress toward `CZH-GATE-88`):

- continue concrete present/outcome seam hardening follow-through edits that
  tighten consolidated derivation paths and invariants in selected scope
...
4. `docs/todo/core/CZH_S29_TICKETS.md`
...
- Engineer executes the current sprint tickets in `docs/todo/core/JIRA_BOARD.md`
  and `docs/todo/core/CZH_S29_TICKETS.md` in listed order.
