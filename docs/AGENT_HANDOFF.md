...
- Active macro batch (`in_progress`, super-gate `CZH-GATE-117`): `CZH-B63` in
...
- Active ticket source: `docs/todo/core/CZH_S58_TICKETS.md`
...
Current batch status (`CZH-B63`, in progress toward `CZH-GATE-117`):

- target: compress canonical entry contract surface and trim non-essential assertion/exposure layers
- preserve no-bypass guarantees while reducing surface noise
...
4. `docs/todo/core/CZH_S58_TICKETS.md`
