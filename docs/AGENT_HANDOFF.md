...
- Investigation residue cleanup is active: probe-grade scroll/control trace logging was removed from core hot paths, and protocol trace noise now defaults to debug level.
