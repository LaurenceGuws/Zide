...
- Active macro batch (`architect_review_pending`, super-gate `CZH-GATE-85`): `CZH-B31` in
  `docs/todo/core/implementation.md`
- Pending sprint checkpoint: `docs/todo/core/CZH_S26_CHECKPOINT.md`
...
Current batch intent (`CZH-B31`, in progress toward `CZH-GATE-85`):

- finish contraction of remaining duplicate surface/result derivation paths to
  canonical helper routes across selected runtime/widget seams
...
4. `docs/todo/core/CZH_S26_TICKETS.md`
...
- Engineer executes the current sprint tickets in `docs/todo/core/JIRA_BOARD.md`
  and `docs/todo/core/CZH_S26_TICKETS.md` in listed order.
