...
- Active macro batch (`in_progress`): `AHW-B13` — app-shell sidebar mutation policy narrowing, behavior-neutral.
...
- Execute only the macro batch currently marked `in_progress` in
  `docs/todo/android/implementation.md` (`AHW-B13`).
- Stop at the `AHW-B13` super-gate and return the review packet for Architect verdict.
