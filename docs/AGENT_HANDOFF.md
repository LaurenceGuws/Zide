...
- Active macro batch (`in_progress`): `AHW-B17` — activity IME state carrier seam consolidation, behavior-neutral.
...
- Execute only the macro batch marked `in_progress` in
  `docs/todo/android/implementation.md` (`AHW-B17`).
- Stop at the `AHW-B17` super-gate and return the review packet for Architect verdict.
