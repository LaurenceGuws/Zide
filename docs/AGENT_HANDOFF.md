...
- Active macro batch (`in_progress`): `AHW-B16` — widget-host IME primitive seam narrowing, behavior-neutral.
...
- Execute only the macro batch marked `in_progress` in
  `docs/todo/android/implementation.md` (`AHW-B16`).
- Stop at the `AHW-B16` super-gate and return the review packet for Architect verdict.
