...
- Active macro batch (`in_progress`, super-gate `CZH-GATE-87`): `CZH-B33` in
...
Current batch intent (`CZH-B33`, in progress toward `CZH-GATE-87`):

- land concrete present/outcome seam hardening edits that tighten consolidated
  derivation paths and invariants in selected scope
...
4. `docs/todo/core/CZH_S28_TICKETS.md`
...
- Engineer executes the current sprint tickets in `docs/todo/core/JIRA_BOARD.md`
  and `docs/todo/core/CZH_S28_TICKETS.md` in listed order.
