...
- Active macro batch (`awaiting_architect_review`): `APX-B1` — `AppShellTerminalSelectionPolicy` + activation seam wiring; engineer stopped at super-gate for architect verdict.
