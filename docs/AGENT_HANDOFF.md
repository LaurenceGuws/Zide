...
- Investigation residue cleanup is active: probe-grade scroll/control trace logging was removed from core hot paths, protocol trace noise now defaults to debug level, and high-frequency input send-path logs were demoted out of default-info output.
