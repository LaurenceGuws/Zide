...
- Active macro batch (`in_progress`, super-gate `CZH-GATE-109`): `CZH-B55` in
...
- Active ticket source: `docs/todo/core/CZH_S50_TICKETS.md`
...
Current batch status (`CZH-B55`, in progress toward `CZH-GATE-109`):

- target: collapse remaining fold-route assertion duplication and simplify transport mapping checks to one canonical route per flow
...
4. `docs/todo/core/CZH_S50_TICKETS.md`
...
- Engineer executes the current sprint tickets in `docs/todo/core/JIRA_BOARD.md`
  and `docs/todo/core/CZH_S50_TICKETS.md` in listed order.
