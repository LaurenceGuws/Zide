...
- Active macro batch (`verdict_pending`): `AHW-B21` — slim widget/composition host-result surfaces for tab-ready host API (no tab product behavior); engineer super-gate packet delivered — Architect review next.
