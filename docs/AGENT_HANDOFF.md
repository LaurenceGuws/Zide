...
- Active macro batch (`in_progress`): `AHW-B12` — app-shell mutation ownership narrowing, behavior-neutral.
...
- Execute only the macro batch currently marked `in_progress` in
  `docs/todo/android/implementation.md` (`AHW-B12`).
- Stop at the `AHW-B12` super-gate and return the review packet for Architect verdict.
