...
- Active macro batch (`in_progress`): `AHW-B18` — host IME callback seam unification, behavior-neutral.
...
- Execute only the macro batch marked `in_progress` in
  `docs/todo/android/implementation.md` (`AHW-B18`).
- Stop at the `AHW-B18` super-gate and return the review packet for Architect verdict.
