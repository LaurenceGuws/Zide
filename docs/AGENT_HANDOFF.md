...
- Active macro batch (`in_progress`, super-gate `CZH-GATE-86`): `CZH-B32` in
...
- Active ticket source: `docs/todo/core/CZH_S27_TICKETS.md`
...
Current batch intent (`CZH-B32`, in progress toward `CZH-GATE-86`):

- land concrete runtime/surface seam contraction edits that eliminate remaining
  duplicate derivation paths in selected scope
...
4. `docs/todo/core/CZH_S27_TICKETS.md`
...
- Engineer executes the current sprint tickets in `docs/todo/core/JIRA_BOARD.md`
  and `docs/todo/core/CZH_S27_TICKETS.md` in listed order.
