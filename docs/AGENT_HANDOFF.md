...
- Active macro batch (`in_progress`, super-gate `CZH-GATE-98`): `CZH-B44` in
...
- Active ticket source: `docs/todo/core/CZH_S39_TICKETS.md`
...
Current batch status (`CZH-B44`, in progress toward `CZH-GATE-98`):

- target: flatten remaining result transport indirections while preserving terminal-owned decision/fold seams
...
4. `docs/todo/core/CZH_S39_TICKETS.md`
...
- Engineer executes the current sprint tickets in `docs/todo/core/JIRA_BOARD.md`
  and `docs/todo/core/CZH_S39_TICKETS.md` in listed order.
