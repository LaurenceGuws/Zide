...
- Active macro batch (`architect_review_pending`, super-gate `CZH-GATE-75`): `CZH-B21` in
...
Current batch intent (`CZH-B21`, in progress toward `CZH-GATE-75`):

- converge selected widget/presentation call sites/tests to explicit generation
  seam vs host-attachment seam ownership
- reduce naming drift without behavior changes
...
4. `docs/todo/core/CZH_S16_TICKETS.md`
...
- Engineer executes the current sprint tickets in `docs/todo/core/JIRA_BOARD.md`
  and `docs/todo/core/CZH_S16_TICKETS.md` in listed order.
