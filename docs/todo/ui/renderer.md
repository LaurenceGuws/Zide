...
init/deinit now routes through backend runtime ops. Android host/bootstrap
work is now merged, so a third backend would still pressure that backend-host
ownership story.
