...
- [x] `TS-08` Grammar pack install tooling
  - Packs install from sibling repo `../zide-tree-sitter/tools/grammar_packs/dist` into `%LOCALAPPDATA%/Zide/grammars` on Windows and `~/.config/zide/grammars` elsewhere.
  - See `docs/todo/editor/treesitter_dynamic_roadmap.md`.
