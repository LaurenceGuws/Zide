...
`AHW-B17` is `in_progress` and is the only active macro batch.
...
Execute `AHW17-M1` through `AHW17-M6` sequentially; do not stop before the
`AHW-B17` super-gate unless a hard stop condition is hit.
