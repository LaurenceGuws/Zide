...
- Current active macro batch: `CZH-B60` (in_progress, super-gate `CZH-GATE-114`). Sprint `CZH-S55` in progress.
...
- Active sprint: `CZH-S55`. Ticket source: `docs/todo/core/CZH_S55_TICKETS.md`.
