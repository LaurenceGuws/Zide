# `CZH-S11` Tickets — surface contract consumer expansion III

Sprint: `CZH-S11`  
Authority parent: accepted clear-generation seam expansion (`CZH-B15`)  
...
### `CZH-656` Audit next draw/presentation-facing seam consumer
...
### `CZH-657` Add minimal seam helper/type for selected path
...
### `CZH-658` Route selected path through seam helper/type
...
### `CZH-659` Add/update focused assertions and sync authority notes
...
### `CZH-660` Validation packet + gate handoff

- Record ladder results in `docs/todo/core/implementation.md`.
- Submit checkpoint packet `docs/todo/core/CZH_S11_CHECKPOINT.md`.
- Move board to `review_gate` at `CZH-GATE-70`.
