...
- Sprint ID: `CZH-S21`
- Objective: long-loop seam pack: lock host-target leg vs full-attachment
  ownership boundaries in present/runtime/state result paths
- Commit budget before checkpoint: `10`
- Super-gate: `CZH-GATE-80`

## Ticket Order (`CZH-S21`)
