...
- Sprint ID: `CZH-S59` (review_gate)
- Previous Sprint: `CZH-S58` (accepted)
- Super-gate: `CZH-GATE-118` (CZH-B64, in_progress)

## Ticket Order (`CZH-S59`)
...
- `in_progress`: none
- `todo`: none
- `review_gate`: `CZH-GATE-118` (CZH-S59)
- `blocked`: none
