...
- Sprint ID: `CZH-S32`
- Previous Sprint: `CZH-S31` (accepted)
- Super-gate: `CZH-GATE-91` (CZH-B37, `review_gate`)

## Ticket Order (`CZH-S32`)
...
- `review_gate`: `CZH-861`, `CZH-862`, `CZH-863`, `CZH-864`, `CZH-865`, `CZH-866`, `CZH-867`, `CZH-868`, `CZH-869`, `CZH-870`
