...
- Sprint ID: `CZH-S14`
- Objective: long-loop seam pack: converge mixed primitive/composite/ffi seam
  consumption under explicit `surface_contract` ownership + scoped hygiene sweep
- Commit budget before checkpoint: `10`
- Super-gate: `CZH-GATE-73`

## Ticket Order (`CZH-S14`)
