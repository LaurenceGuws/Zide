...
- Sprint ID: `CZH-S19`
- Objective: long-loop seam pack: align observability/log vocabulary with the
  locked pipeline-vs-attachment-vs-generation state model
- Commit budget before checkpoint: `10`
- Super-gate: `CZH-GATE-78`

## Ticket Order (`CZH-S19`)
