...
- Sprint ID: `CZH-S60` (review_gate)
- Previous Sprint: `CZH-S59` (accepted)
- Super-gate: `CZH-GATE-119` (CZH-B65, in_progress)

## Ticket Order (`CZH-S60`)
...
- `in_progress`: none
- `todo`: none
- `review_gate`: `CZH-GATE-119` (CZH-S60)
- `blocked`: none
