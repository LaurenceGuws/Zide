...
- Sprint ID: `CZH-S63` (in_progress)
- Previous Sprint: `CZH-S62` (accepted)
- Super-gate: `CZH-GATE-122` (CZH-B68, in_progress)
...
- `in_progress`: `CZH-1149`
- `todo`: `CZH-1150`, `CZH-1151`, `CZH-1152`, `CZH-1153`, `CZH-1154`, `CZH-1155`, `CZH-1156`
- `review_gate`: none
- `blocked`: none
