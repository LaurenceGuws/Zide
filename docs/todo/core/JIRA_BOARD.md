...
- Sprint ID: `CZH-S20`
- Objective: long-loop seam pack: reduce remaining alias terms so each locked
  state concept has one dominant term in selected widget/runtime/surface paths
- Commit budget before checkpoint: `10`
- Super-gate: `CZH-GATE-79`

## Ticket Order (`CZH-S20`)
