...
- Sprint ID: `CZH-S23`
- Objective: long-loop seam pack: consolidate dominant reporting carrier for
  present-time conjunction visibility in selected runtime/widget paths
- Commit budget before checkpoint: `10`
- Super-gate: `CZH-GATE-82`

## Ticket Order (`CZH-S23`)
