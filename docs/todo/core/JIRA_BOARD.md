...
- Sprint ID: `CZH-S15`
- Objective: long-loop seam pack: shape host-owned shared-surface attachment
  contract in Zig and converge touched widget/runtime consumers
- Commit budget before checkpoint: `10`
- Super-gate: `CZH-GATE-74`

## Ticket Order (`CZH-S15`)
