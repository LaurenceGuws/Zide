...
- Sprint ID: `CZH-S33`
- Previous Sprint: `CZH-S32` (accepted)
- Super-gate: `CZH-GATE-92` (CZH-B38, `in_progress`)

## Ticket Order (`CZH-S33`)
...
- `in_progress`: `CZH-871`
- `todo`: `CZH-872`, `CZH-873`, `CZH-874`, `CZH-875`, `CZH-876`, `CZH-877`, `CZH-878`, `CZH-879`, `CZH-880`
- `blocked`: none
