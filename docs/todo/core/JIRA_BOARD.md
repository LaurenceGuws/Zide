...
- Sprint ID: `CZH-S65` (review_gate at CZH-GATE-124)
- Previous Sprint: `CZH-S64` (accepted)
- Super-gate: `CZH-GATE-124` (enforcement signal compression with verifiability retention)

## Ticket Order (`CZH-S65`)
...
- `in_progress`: none
- `todo`: none
- `review_gate`: `CZH-1165`, `CZH-1166`, `CZH-1167`, `CZH-1168`, `CZH-1169`, `CZH-1170`, `CZH-1171`, `CZH-1172` (CZH-S65, in_progress)
- `blocked`: none
