...
- Sprint ID: `CZH-S16`
- Objective: long-loop seam pack: converge generation-vs-attachment seam
  ownership at selected widget/presentation call sites + tests/docs
- Commit budget before checkpoint: `10`
- Super-gate: `CZH-GATE-75`

## Ticket Order (`CZH-S16`)
