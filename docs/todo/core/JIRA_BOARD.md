...
- Sprint ID: `CZH-S28`
- Objective: long-loop seam pack: present/outcome seam hardening with concrete
  implementation cuts and invariant locks
- Commit budget before checkpoint: `10`
- Super-gate: `CZH-GATE-87`

## Ticket Order (`CZH-S28`)
