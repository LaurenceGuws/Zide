...
- Sprint ID: `CZH-S18`
- Objective: long-loop seam pack: lock shared vocabulary for pipeline leg vs
  attachment conjunction vs generation terms in selected widget/runtime/state paths
- Commit budget before checkpoint: `10`
- Super-gate: `CZH-GATE-77`

## Ticket Order (`CZH-S18`)
