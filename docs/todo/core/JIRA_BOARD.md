...
- Sprint ID: `CZH-S30`
- Next Sprint ID: `CZH-S31`
- Previous Sprint: `CZH-S29` (accepted)
- Super-gate: `CZH-GATE-89` (CZH-B35, `in_progress`)
...
- `in_progress`: `CZH-841`
- `todo`: `CZH-842`, `CZH-843`, `CZH-844`, `CZH-845`, `CZH-846`, `CZH-847`, `CZH-848`, `CZH-849`, `CZH-850`
- `blocked`: none
- `review_gate`: none
