...
- Sprint ID: `CZH-S66` (in_progress)
- Previous Sprint: `CZH-S65` (accepted)
- Super-gate: `CZH-GATE-125` (CZH-B71, in_progress)
...
- `in_progress`: `CZH-1173`
- `todo`: `CZH-1174`, `CZH-1175`, `CZH-1176`, `CZH-1177`, `CZH-1178`, `CZH-1179`, `CZH-1180`
- `review_gate`: none
- `blocked`: none
