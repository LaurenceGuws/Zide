...
- Sprint ID: `CZH-S64` (review_gate at CZH-GATE-123)
- Previous Sprint: `CZH-S63` (accepted)
- Super-gate: `CZH-GATE-123` (enforcement surface compaction with lock preservation)

## Ticket Order (`CZH-S64`)
...
- `in_progress`: none
- `todo`: none
- `review_gate`: `CZH-1157`, `CZH-1158`, `CZH-1159`, `CZH-1160`, `CZH-1161`, `CZH-1162`, `CZH-1163`, `CZH-1164` (CZH-S64, in_progress)
- `blocked`: none
