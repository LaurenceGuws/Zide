...
3. `docs/todo/core/CZH_S33_TICKETS.md`
...
- `CZH-B38` — **`in_progress`** toward **`CZH-GATE-92`** (sprint `CZH-S33`):
  terminal presentation runtime ownership extraction (widget facade contraction + terminal-owned orchestration).
  Ticket source: `docs/todo/core/CZH_S33_TICKETS.md`.
...
- Sprint `CZH-S33` tickets `CZH-871`..`CZH-880` are active; run to
  **`CZH-GATE-92`** unless blocked.
