...
3. `docs/todo/core/CZH_S59_TICKETS.md`
...
- `CZH-B64` — **`in_progress`** toward **`CZH-GATE-118`** (sprint `CZH-S59`):
  canonical entry contract final surface seal: remove residual exposure edges and lock final no-bypass/parity guarantees.
  Ticket source: `docs/todo/core/CZH_S59_TICKETS.md`.
...
- Sprint `CZH-S59` tickets `CZH-1117`..`CZH-1124` are active; run to
  **`CZH-GATE-118`** unless blocked.
