...
3. `docs/todo/core/CZH_S42_TICKETS.md`
...
- `CZH-B47` — **`in_progress`** toward **`CZH-GATE-101`** (sprint `CZH-S42`):
  boundary helper contraction and refresh/reuse result narrowing after `CZH-B46` acceptance.
  Ticket source: `docs/todo/core/CZH_S42_TICKETS.md`.
...
- Sprint `CZH-S42` tickets `CZH-961`..`CZH-970` are active; run to
  **`CZH-GATE-101`** unless blocked.
