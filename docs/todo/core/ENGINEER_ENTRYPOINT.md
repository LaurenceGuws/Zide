...
3. `docs/todo/core/CZH_S30_TICKETS.md`
...
- `CZH-B35` — **`in_progress`** toward **`CZH-GATE-89`** (sprint `CZH-S30`):
  present/outcome seam consolidation follow-through with concrete canonical
  route edits across selected runtime/widget seams (`docs/todo/core/CZH_S30_TICKETS.md`).
...
- Sprint `CZH-S30` tickets `CZH-841`..`CZH-850` are active; run to
  **`CZH-GATE-89`** unless blocked.
