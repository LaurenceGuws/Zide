...
const app_editor_actions = @import("../src/app/editor/editor_actions.zig");
const app_mode_adapter_sync_runtime = @import("../src/app/mode_adapter_sync_runtime.zig");
const app_modes = @import("../src/app/modes/mod.zig");
const app_search_panel_input = @import("../src/app/search/search_panel_input.zig");
const app_search_panel_state = @import("../src/app/search/search_panel_state.zig");
...
const terminal_session_runtime_factory = @import("../src/app/terminal/terminal_session_runtime_factory.zig");
...
test "terminal workspace reorder keeps widget session aligned with active tab" {
    ...
    try app.terminal_widgets.append(allocator, terminal_session_runtime_factory.initWidget(created_1.session, .kitty, true, false));
    try app.terminal_widgets.append(allocator, terminal_session_runtime_factory.initWidget(created_2.session, .kitty, true, false));
    try app.terminal_widgets.append(allocator, terminal_session_runtime_factory.initWidget(created_3.session, .kitty, true, false));
