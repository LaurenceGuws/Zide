...
- keep tightly coupled tests near the subsystem they exercise
  - example: `src/terminal/core/pty_terminal_runtime_tests.zig`
...
- [pty_terminal_runtime_tests.zig](../src/terminal/core/pty_terminal_runtime_tests.zig)
  - stays source-adjacent because it is tightly coupled to `PtyTerminalRuntime` ownership and regression locality matters more than one fewer file in `tests/`
