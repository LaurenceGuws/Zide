...
pub fn addReportBuildProfilesStep(
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            .root_source_file = b.path("tools/build/build_profile_report.zig"),
            .target = target,
            .optimize = optimize,
        }),
    });
...
pub fn addReportBuildModeStep(
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            .root_source_file = b.path("tools/build/build_mode_report.zig"),
            .target = target,
            .optimize = optimize,
        }),
    });
...
pub fn addReportBuildBootstrapStep(
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            .root_source_file = b.path("tools/build/build_bootstrap_report.zig"),
            .target = target,
            .optimize = optimize,
        }),
    });
...
pub fn addReportBuildFocusedPolicyStep(
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            .root_source_file = b.path("tools/build/build_focused_mode_policy_check.zig"),
            .target = target,
            .optimize = optimize,
        }),
    });
...
pub fn addReportBuildTargetStep(
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            .root_source_file = b.path("tools/build/build_target_report.zig"),
            .target = target,
            .optimize = optimize,
        }),
    });
