...
- Renderer cleanup continues: input constants, clipboard helpers, texture utilities, window event helpers, and text input rect handling extracted into renderer/platform modules (see renderer_todo).
