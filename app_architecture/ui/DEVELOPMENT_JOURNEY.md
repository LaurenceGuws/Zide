...
- Renderer cleanup continues: input constants, clipboard helpers, texture utilities, and window event helpers extracted into renderer/platform modules (see renderer_todo).
