...
- shell chrome is now carved out behind `renderer_chrome_band_host.zig`
- terminal overlay/progress visuals are now carved out behind
...
- terminal overlay/progress duplicate paths
