...
| `host/ui/ProductTerminalTabDescriptors.java` | Good | Default harness tab table from `strings.xml` labels + stable string ids; must stay aligned with `PRODUCT_TERMINAL_TAB_COUNT`. | Update when tab count or default labels change. |
