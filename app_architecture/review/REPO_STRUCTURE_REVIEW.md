...
- fifth cleanup slice landed: the completed `app_mode_layering_todo.md` tracker was moved into `app_architecture/review/` because it is now historical rollout context, not an active queue
